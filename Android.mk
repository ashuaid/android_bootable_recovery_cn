...
CWM_BASE_VERSION := $(RECOVERY_NAME) v6.0.3.7
...
RECOVERY_MOD_NAME := TD之家高级恢复中文系统
endif
endif

RECOVERY_MOD_VERSION := $(RECOVERY_MOD_NAME)
#PHILZ_BUILD := TD之家
PHILZ_BUILD := $(PRODUCT_MANUFACTURER) $(PRODUCT_MODEL)
...
else ifeq ($(TARGET_PRODUCT), cm_ja3g)
TARGET_COMMON_NAME := i9500
BOARD_USE_FB2PNG := false
BOARD_USE_NTFS_3G := false
LOCAL_CFLAGS += -DTARGET_DEVICE_I9500

#Galaxy S4 International - i9502
else ifeq ($(TARGET_PRODUCT), cm_i9502)
TARGET_COMMON_NAME := i9502
BOARD_USE_FB2PNG := false
BOARD_USE_NTFS_3G := false
LOCAL_CFLAGS += -DTARGET_DEVICE_I9502
...
#Galaxy S4 - E330S, ks01lteskt
else ifeq ($(TARGET_PRODUCT),cm_E330S)
TARGET_COMMON_NAME := E330S
LOCAL_CFLAGS += -DTARGET_DEVICE_E330S
LOCAL_CFLAGS += -DBOARD_HAS_SLOW_STORAGE
